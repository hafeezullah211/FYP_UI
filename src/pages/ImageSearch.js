...
<h3 style={{fontFamily:"Helvetica",color:"white"}}>
    Search Results
  </h3>
  <CardContent>
                  ...
                  <Col  lg="3" md="3" sm="4" xs="6" >
                    ...
                    <Card   > 
                      ...
                      <CardMedia  className="itemCardImageDiv" >
                         ...
                         <img  src={suggestedProducts.imageLink} alt="No image" className="img-fluid"  style={{Height:"350px"}}/>
